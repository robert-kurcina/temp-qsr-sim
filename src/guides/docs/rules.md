...
| [Bonus Actions & Passive Options](./rules-bonus-actions) | Cascade spending, Bonus Actions, Passive Player Options |
...
| [Movement](./rules-movement) | Detailed movement rules and Agility |
| [Falling, Swap, & Confinement](./rules-falling-swap-confined) | Falling damage, swapping positions, confined spaces |
...
| [Advanced Game Rules](./rules-advanced-game) | **DEFERRED** — Advanced rules index (Fire, ROF, Suppression, etc.) |
...
| Rule Module | Description |
|-------------|-------------|
| [Weapons Reference](./rules-weapons-reference) | Complete weapons list with stats and BP costs |
...
3. [Variant Archetypes](./rules-variant-archetypes)
4. [Traits](./rules-traits)
5. [Traits List](./rules-traits-list)
6. [Items](./rules-items)
7. [Weapons Reference](./rules-weapons-reference)
8. [Armors Reference](./rules-armors-reference)
9. [Armor Materials](./rules-armor-materials)
10. [Technology & Genres](./rules-technology-genres)
11. [Portraits](./rules-portraits)
...
5. [Bonus Actions & Passive Options](./rules-bonus-actions)
6. [Close Combat](./rule-close-combat)
7. [Direct Range Combat](./rule-direct-range-combat)
8. [Disengage](./rule-disengage)
9. [Reasonable Behavior](./rule-reasonable-behavior)
10. [Damage & Morale](./rules-damage-and-morale)

### Movement & Positioning
1. [Movement & Terrain](./rules-movement-and-terrain)
2. [Movement](./rules-movement)
3. [Falling, Swap, & Confinement](./rules-falling-swap-confined)
4. [Visibility & Lighting](./rules-visibility)
5. [Terrain](./rules-terrain)
6. [Size & Base Diameter](./rules-size-base-diameter)
7. [Situational Modifiers](./rules-situational-modifiers)

### Advanced Play
1. [Advanced Rules](./rules-advanced)
2. [Bonus Actions & Passive Options](./rules-bonus-actions)
3. [Friendly Fire & LOF](./rules-friendly-fire-los)
4. [Scatter Diagram](./rules-scatter)
5. [Indirect Combat](./rules-indirect)
6. [Multiple Weapons](./rules-multiple)
7. [Random Selection](./rules-random-selection)
...
4. [Weapons Reference](./rules-weapons-reference)
5. [Armors Reference](./rules-armors-reference)
6. [Armor Materials](./rules-armor-materials)
7. [Variant Archetypes](./rules-variant-archetypes)
8. [Random Selection](./rules-random-selection)
