...
| Items & Equipment | `src/guides/docs/rules-items.md` | `src/lib/mest-tactics/core/Item.ts`, `src/lib/mest-tactics/utils/profile-generator.ts` | Partial | Data exists; some equipment behaviors are not implemented. |
| Multiple Weapons | `src/guides/docs/rules-multiple.md` | `src/lib/mest-tactics/actions/hand-requirements.ts` | Partial | Hand limits exist; some nuanced rules not enforced. |
...
| Indirect Combat | `src/guides/docs/rules-indirect.md` | `src/lib/mest-tactics/combat/indirect-ranged-combat.ts`, `src/lib/mest-tactics/combat/scatter.ts` | Partial | Hit test + scatter exist; AoE/Frag and Scrambling not fully wired. |
| Scatter Diagram | `src/guides/docs/rules-scatter.md` | `src/lib/mest-tactics/combat/scatter.ts` | Partial | Scatter engine exists; bias handling is configurable but doc mismatch noted below. |
...
| Scatter | `src/guides/docs/rules-indirect.md`, `src/guides/docs/rules-scatter.md` | `src/lib/mest-tactics/combat/scatter.ts` | Partial | Engine exists; bias and integration into indirect attacks in progress. |
...
| Scrambling React | `src/guides/docs/rules-indirect.md`, `src/guides/docs/rules-advanced.md` | N/A | Missing | To be wired into react system or indirect action path. |
| AoE / Frag Resolution | `src/guides/docs/rules-indirect.md` | N/A | Missing | To be wired into indirect attack resolution. |

## Known Doc Mismatches to Resolve

| Item | Location | Mismatch |
|---|---|---|
| Scatter Bias | `src/guides/docs/rules-scatter.md` | Doc currently assumes unbiased directions; QSR notes biased diagram. |
